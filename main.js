...
function validation_check(account_number, pin) {
...
function withdrawal(amount_to_be_withdrawal, user_name, account_number, pin) {
...
function cash_deposit(amount_to_be_deposit, user_name, account_number, pin) {
    if (validation_check(account_number, pin)) {
        const name = user_name;
        const value = users[name];
...
function balance_inquiry(user_name, account_number, pin) {
    if (validation_check(account_number, pin)) {
        const name = user_name;
        const value = users[name];
